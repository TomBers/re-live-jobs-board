defmodule LiveJobsBoardWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule LiveJobsBoard.MyChannel do
        use LiveJobsBoardWeb, :channel
        alias LiveJobsBoardWeb.Presence
  ...
  use Phoenix.Presence,
    otp_app: :live_jobs_board,
    pubsub_server: LiveJobsBoard.PubSub
end
